export const AgenciesApiTranslations = {
  success: {
    imports: "As agências foram importadas com sucesso",
    post: "A agência foi criada com sucesso!",
    put: "A agência foi atualizada com sucesso!",
    delete: "A agência foi excluída com sucesso!",
    patch: "A categoria do(s) agência(s) foi atualizada(os) com sucesso!",
  },
  invalid: {
    id: "A agência não pode ser encontrada com o ID informado",
    ...
    in_ids: "As agências informadas encontram-se com alguma irregularidade",
    client: "A agência informada encontra-se inexistente ou inválida",
    clients: "As agências informadas encontram-se inexistentes ou inválidas",
    ...
    cnpj: "O CNPJ informado da agência encontra-se inválido",
