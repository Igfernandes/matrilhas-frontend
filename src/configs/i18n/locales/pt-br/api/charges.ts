export const chargesApiTranslations = {
  ...
  invalid: {
    ...
    expired_days: "Os dias para expiração da cobrança estão inválidos",
    price: "O preço da cobrança é inválido",
    name: "O nome da cobrança está inválido",
    ...
    agency_id: "A agência informada não existe ou está inválida",
    client_id: "O cliente informado não existe ou está inválido",
    started_at: "A data de início da cobrança está inválida",
    not_found_bank: "O banco informado não existe ou está inválido",
    not_found_client: "O cliente informado não existe ou está inválido",
    not_found_agency: "A agência informada não existe ou está inválida",
    ...
    start: "O período inicial informado está inválido",
    limit: "O limite informado está inválido",
    name_or_service:
