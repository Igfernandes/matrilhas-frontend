        ...
        <>
            <div className="flex flex-wrap bg-white justify-around w-[95%] lg:w-[50%] px-8 py-3 shadow-md rounded-full mt-[-4rem] relative z-10 mx-auto ">
                <form className="flex items-center flex-wrap justify-center md:justify-start" action="/tours" method="get">
                    <label htmlFor="search" className="mr-5 w-full text-center md:w-auto font-semibold text-primary">{t("Screens.home.search_label")}</label>
                    <div className="relative w-full md:w-auto mt-2 md:mt-0">
                        <input type="text" name="title_contains" id="search" placeholder={t("Words.search")+"..."} className="border border-gray-300 pr-20 rounded-full px-4 py-2 w-full lg:w-auto" />
