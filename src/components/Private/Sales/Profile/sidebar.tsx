        ...
        <div className="flex flex-wrap justify-between h-full">
            <div className="w-full">
                ...
                <div className="w-full mt-8">
                    <Image className="rounded-full mx-auto mb-2 border-2 border-secondary" width={130} height={130} src={logotype ? logotype : "/imgs/previews/preview-300x300.png"} alt="Logotype" />
