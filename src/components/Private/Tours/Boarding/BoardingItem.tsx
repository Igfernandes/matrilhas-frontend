...
import { BoardingPayload } from "./BoardingSchemas";
...
export function BoardingItem({ id, onRemove }: Props) {
    const { t } = useI18n()
    ...
    const { register, watch, formState: { errors } } = useFormContext<BoardingPayload>()
                ...
                <div className="mt-2">
                    ...
                    <div className="flex flex-wrap justify-between pb-5">
                        <div className="w-full md:w-[30%] my-2">
                            <Input type="hidden" dataTestId="destiny_type" {...register(`address.${id}.type`)} defaultValue={"ORIGIN"} />
