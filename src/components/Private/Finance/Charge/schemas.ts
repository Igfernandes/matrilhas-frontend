...
export const ChargeUpdateSchema = z.object({
  ...
  period: z.string({ required_error: i18n("errors.fields.required") }),
  expired_days: z.string({ required_error: i18n("errors.fields.required") }),
  started_at: z.string({ required_error: i18n("errors.fields.required") }),
